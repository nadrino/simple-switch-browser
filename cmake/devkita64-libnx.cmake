...
add_definitions(-D __SWITCH__)
#set(ARCH "-march=armv8-a -mtune=cortex-a57 -mtp=soft -fPIE")
set(ARCH "-march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fPIE")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${ARCH} -g -O2 -ffunction-sections -Wno-unused-variable")
#set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -MMD -MP -g -O2 -ffunction-sections ${ARCH} -Wno-unused-variable")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CMAKE_C_FLAGS} -std=gnu++17")
#set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CMAKE_C_FLAGS} -std=gnu++17 -fexceptions -Wno-unused-variable")
